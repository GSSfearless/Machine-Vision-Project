...
N_3_stretch = zeros(26,26)
N_3_stretch(1:4,:) = N_3(1:4,:)
N_3_stretch(5:11,:) = N_3_up
N_3_stretch(12:15,:) = N_3(6:9,:)
N_3_stretch(16:22,:) =N_3_low
N_3_stretch(23:26,:) = N_3(11:14,:)
N_3_stretch = imadjust(N_3_stretch,[0.01 0.02],[0 1])
N_3_stretch= imcomplement(N_3_stretch)
N_3_stretch_255 = N_3_stretch.*255
N3_stretch_255 = reshape(N_3_stretch_255,1,[])


N_3_stretch_32 = N_3_stretch.* 32
N3_stretch_32 = reshape(N_3_stretch_32,1,[])

N_3_stretch_64 = N_3_stretch.* 64
N3_stretch_64 = reshape(N_3_stretch_64,1,[])


N_3_stretch_128 = N_3_stretch.* 128
N3_stretch_128 = reshape(N_3_stretch_128,1,[])

N_3_stretch_150 = N_3_stretch.* 150
N3_stretch_150 = reshape(N_3_stretch_150,1,[])

N_3_stretch_170 = N_3_stretch.* 170
N3_stretch_170 = reshape(N_3_stretch_170,1,[])

N_3_stretch_190 = N_3_stretch.* 190
N3_stretch_190 = reshape(N_3_stretch_190,1,[])

N_3_stretch_200 = N_3_stretch.* 200
N3_stretch_200 = reshape(N_3_stretch_200,1,[])
...
N_3_255 = zeros(26,26)
N_3_255(1:7,:) = zeros(7,26)
N_3_255(8:11,:)= N_3(1:4,:)
N_3_255(12:15,:)= N_3(6:9,:)
N_3_255(16:19,:)= N_3(11:14,:)
N_3_255(20:26,:)= zeros(7,26)
N_3_255 = imadjust(N_3_255,[0.01 0.02],[0 1])
N_3_255= imcomplement(N_3_255)
N_3_255 = N_3_255.*255
N3_255 = reshape(N_3_255,1,[])


N_3_2 = zeros(26,26)
N_3_2(1:7,:) = zeros(7,26)
N_3_2(8:11,:)= N_3(1:4,:)
N_3_2(12:15,:)= N_3(6:9,:)
N_3_2(16:19,:)= N_3(11:14,:)
N_3_2(20:26,:)= zeros(7,26)
N_3_2 = imadjust(N_3_2,[0.01 0.02],[0 1])
N_3_2= imcomplement(N_3_2)
N_3_2 = N_3_2.* 2
N3_2 = reshape(N_3_2,1,[])

N_3_4 = zeros(26,26)
N_3_4(1:7,:) = zeros(7,26)
N_3_4(8:11,:)= N_3(1:4,:)
N_3_4(12:15,:)= N_3(6:9,:)
N_3_4(16:19,:)= N_3(11:14,:)
N_3_4(20:26,:)= zeros(7,26)
N_3_4 = imadjust(N_3_4,[0.01 0.02],[0 1])
N_3_4= imcomplement(N_3_4)
N_3_4 = N_3_4.* 4
N3_4 = reshape(N_3_4,1,[])

N_3_8 = zeros(26,26)
N_3_8(1:7,:) = zeros(7,26)
N_3_8(8:11,:)= N_3(1:4,:)
N_3_8(12:15,:)= N_3(6:9,:)
N_3_8(16:19,:)= N_3(11:14,:)
N_3_8(20:26,:)= zeros(7,26)
N_3_8 = imadjust(N_3_8,[0.01 0.02],[0 1])
N_3_8= imcomplement(N_3_8)
N_3_8 = N_3_8.* 8 
N3_8 = reshape(N_3_8,1,[])

N_3_16 = zeros(26,26)
N_3_16(1:7,:) = zeros(7,26)
N_3_16(8:11,:)= N_3(1:4,:)
N_3_16(12:15,:)= N_3(6:9,:)
N_3_16(16:19,:)= N_3(11:14,:)
N_3_16(20:26,:)= zeros(7,26)
N_3_16 = imadjust(N_3_16,[0.01 0.02],[0 1])
N_3_16= imcomplement(N_3_16)
N_3_16 = N_3_16.* 16
N3_16 = reshape(N_3_16,1,[])


N_3_32 = zeros(26,26)
N_3_32(1:7,:) = zeros(7,26)
N_3_32(8:11,:)= N_3(1:4,:)
N_3_32(12:15,:)= N_3(6:9,:)
N_3_32(16:19,:)= N_3(11:14,:)
N_3_32(20:26,:)= zeros(7,26)
N_3_32 = imadjust(N_3_32,[0.01 0.02],[0 1])
N_3_32= imcomplement(N_3_32)
N_3_32 = N_3_32.* 32
N3_32 = reshape(N_3_32,1,[])

N_3_64 = zeros(26,26)
N_3_64(1:7,:) = zeros(7,26)
N_3_64(8:11,:)= N_3(1:4,:)
N_3_64(12:15,:)= N_3(6:9,:)
N_3_64(16:19,:)= N_3(11:14,:)
N_3_64(20:26,:)= zeros(7,26)
N_3_64 = imadjust(N_3_64,[0.01 0.02],[0 1])
N_3_64= imcomplement(N_3_64)
N_3_64 = N_3_64.*64
N3_64 = reshape(N_3_64,1,[])


N_3_128 = zeros(26,26)
N_3_128(1:7,:) = zeros(7,26)
N_3_128(8:11,:)= N_3(1:4,:)
N_3_128(12:15,:)= N_3(6:9,:)
N_3_128(16:19,:)= N_3(11:14,:)
N_3_128(20:26,:)= zeros(7,26)
N_3_128 = imadjust(N_3_128,[0.01 0.02],[0 1])
N_3_128= imcomplement(N_3_128)
N_3_128 = N_3_128.* 128
N3_128 = reshape(N_3_128,1,[])



N_3_150 = zeros(26,26)
N_3_150(1:7,:) = zeros(7,26)
N_3_150(8:11,:)= N_3(1:4,:)
N_3_150(12:15,:)= N_3(6:9,:)
N_3_150(16:19,:)= N_3(11:14,:)
N_3_150(20:26,:)= zeros(7,26)
N_3_150 = imadjust(N_3_150,[0.01 0.02],[0 1])
N_3_150= imcomplement(N_3_150)
N_3_150 = N_3_150.*150
N3_150 = reshape(N_3_150,1,[])


N_3_160 = zeros(26,26)
N_3_160(1:7,:) = zeros(7,26)
N_3_160(8:11,:)= N_3(1:4,:)
N_3_160(12:15,:)= N_3(6:9,:)
N_3_160(16:19,:)= N_3(11:14,:)
N_3_160(20:26,:)= zeros(7,26)
N_3_160 = imadjust(N_3_160,[0.01 0.02],[0 1])
N_3_160= imcomplement(N_3_160)
N_3_160 = N_3_160.* 160
N3_160 = reshape(N_3_160,1,[])


N_3_180 = zeros(26,26)
N_3_180(1:7,:) = zeros(7,26)
N_3_180(8:11,:)= N_3(1:4,:)
N_3_180(12:15,:)= N_3(6:9,:)
N_3_180(16:19,:)= N_3(11:14,:)
N_3_180(20:26,:)= zeros(7,26)
N_3_180 = imadjust(N_3_180,[0.01 0.02],[0 1])
N_3_180= imcomplement(N_3_180)
N_3_180 = N_3_180.* 180
N3_180 = reshape(N_3_180,1,[])


N_3_190 = zeros(26,26)
N_3_190(1:7,:) = zeros(7,26)
N_3_190(8:11,:)= N_3(1:4,:)
N_3_190(12:15,:)= N_3(6:9,:)
N_3_190(16:19,:)= N_3(11:14,:)
N_3_190(20:26,:)= zeros(7,26)
N_3_190 = imadjust(N_3_190,[0.01 0.02],[0 1])
N_3_190= imcomplement(N_3_190)
N_3_190 = N_3_190.*190
N3_190 = reshape(N_3_190,1,[])


N_3_200 = zeros(26,26)
N_3_200(1:7,:) = zeros(7,26)
N_3_200(8:11,:)= N_3(1:4,:)
N_3_200(12:15,:)= N_3(6:9,:)
N_3_200(16:19,:)= N_3(11:14,:)
N_3_200(20:26,:)= zeros(7,26)
N_3_200 = imadjust(N_3_200,[0.01 0.02],[0 1])
N_3_200= imcomplement(N_3_200)
N_3_200 = N_3_200.*200
N3_200 = reshape(N_3_200,1,[])
